...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --disable-gpl --disable-version3 --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-everything --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder=aac_fixed --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=ac3 --enable-decoder=ape --enable-decoder=flac --enable-decoder=h263 --enable-decoder=h264 --enable-decoder=h264 --enable-decoder=mp2 --enable-decoder=mp2float --enable-decoder=mp3 --enable-decoder=mp3adu --enable-decoder=mp3adufloat --enable-decoder=mp3float --enable-decoder=mp3on4 --enable-decoder=mp3on4float --enable-decoder=msmpeg4v2 --enable-decoder=msvideo1 --enable-decoder=mpeg2video --enable-decoder=mpeg4 --enable-decoder=movtext --enable-decoder=pcm_s16le_planar --enable-decoder=pcm_s24be --enable-decoder=pcm_s24daud --enable-decoder=pcm_s24le --enable-decoder=pcm_s32be --enable-decoder=pcm_s32le --enable-decoder=pcm_mulaw --enable-decoder=pcm_alaw --enable-decoder=pcm_s8_planar --enable-decoder=pcm_u16be --enable-decoder=pcm_s16le --enable-decoder=pcm_u8 --enable-decoder=pcm_u16le --enable-decoder=pcm_u24be --enable-decoder=pcm_u24le --enable-decoder=pcm_u32be --enable-decoder=pcm_u32le --enable-decoder=pcm_f32le --enable-decoder=pcm_s16be --enable-decoder=pcm_dvd --enable-decoder=mpegvideo --enable-decoder=mpeg2video --enable-decoder=mpeg4 --enable-decoder=msmpeg4_crystalhd --enable-decoder=msmpeg4v1 --enable-decoder=msmpeg4v2 --enable-decoder=msmpeg4v3 --enable-decoder=vorbis --enable-decoder=vp8 --enable-decoder=jpeg2000 --enable-decoder=jpegls --enable-decoder=bmp --enable-decoder=png --enable-decoder=hevc --enable-decoder=mjpeg --enable-decoder=wmav2 --enable-decoder=amrnb --enable-decoder=wavpack --enable-decoder=libopencore_amrnb --enable-decoder=libopencore_amrwb --disable-hwaccels --disable-muxers --enable-muxer=mpegts --enable-muxer=mp4 --enable-muxer=mp3 --disable-demuxers --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=ape --enable-demuxer=asf --enable-demuxer=asf_o --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flac --enable-demuxer=flv --enable-demuxer=h263 --enable-demuxer=h264 --enable-demuxer=hls --enable-demuxer=h264 --enable-demuxer=live_flv --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mjpeg --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=mpegvideo --enable-demuxer=ogg --enable-demuxer=pcm_alaw --enable-demuxer=pcm_f32be --enable-demuxer=pcm_f32le --enable-demuxer=pcm_f64be --enable-demuxer=pcm_f64le --enable-demuxer=pcm_mulaw --enable-demuxer=pcm_s16be --enable-demuxer=pcm_s16le --enable-demuxer=pcm_s24be --enable-demuxer=pcm_s24le --enable-demuxer=pcm_s32be --enable-demuxer=pcm_s32le --enable-demuxer=pcm_s8 --enable-demuxer=pcm_u8 --enable-demuxer=pcm_u16be --enable-demuxer=pcm_u16le --enable-demuxer=rtp --enable-demuxer=rtsp --enable-demuxer=webm_dash_manifest --enable-demuxer=wav --enable-demuxer=wav --enable-demuxer=hevc --enable-demuxer=image_png_pipe --enable-demuxer=image_jpeg_pipe --enable-demuxer=image_bmp_pipe --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=ac3 --enable-parser=flac --enable-parser=h263 --enable-parser=h264 --disable-parser=bmp --disable-parser=dnxhd --enable-parser=h264 --enable-parser=hevc --enable-parser=mjpeg --enable-parser=rv30 --enable-parser=mpeg4video --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-parser=png --enable-parser=vorbis --enable-parser=vp8 --enable-parser=vp9 --disable-bsfs --enable-protocols --enable-protocol=rtmps --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtmpte --enable-protocol=rtmpts --enable-protocol=file --enable-protocol=data --enable-protocol=hls --enable-protocol=udp --enable-protocol=udplite --enable-protocol=rtp --enable-protocol=httpproxy --enable-protocol=ftp --disable-devices --enable-filters --disable-filter=abench --disable-filter=abitscope --disable-filter=acompressor --disable-filter=acrossfade --disable-filter=acrusher --disable-filter=adelay --disable-filter=adrawgraph --disable-filter=aecho --disable-filter=aemphasis --disable-filter=aeval --disable-filter=aevalsrc --disable-filter=afade --disable-filter=afftfilt --disable-filter=aformat --disable-filter=agate --disable-filter=ahistogram --disable-filter=ainterleave --disable-filter=alimiter --disable-filter=allpass --disable-filter=allrgb --disable-filter=allyuv --disable-filter=aloop --disable-filter=alphaextract --disable-filter=alphamerge --disable-filter=amerge --disable-filter=ametadata --disable-filter=amix --disable-filter=amovie --disable-filter=anequalizer --disable-filter=anoisesrc --disable-filter=apad --disable-filter=aperms --disable-filter=aphasemeter --disable-filter=aphaser --disable-filter=apulsator --disable-filter=arealtime --enable-filter=aresample --disable-filter=aselect --disable-filter=asendcmd --disable-filter=asetpts --disable-filter=asetrate --disable-filter=asettb --disable-filter=ashowinfo --disable-filter=asidedata --disable-filter=asplit --disable-filter=astats --disable-filter=astreamselect --disable-filter=atadenoise --disable-filter=atrim --disable-filter=avectorscope --disable-filter=avgblur --disable-filter=bandpass --disable-filter=bandreject --disable-filter=bass --disable-filter=bbox --disable-filter=bench --disable-filter=biquad --disable-filter=bitplanenoise --disable-filter=blackdetect --disable-filter=blackframe --disable-filter=testsrc --disable-filter=testsrc2 --disable-filter=threshold --disable-filter=thumbnail --disable-filter=tile --disable-filter=tinterlace --disable-filter=blend --disable-filter=boxblur --disable-filter=bwdif --disable-filter=cellauto --disable-filter=channelmap --disable-filter=channelsplit --disable-filter=chorus --disable-filter=chromakey --disable-filter=ciescope --disable-filter=codecview --disable-filter=colorbalance --disable-filter=colorchannelmixer --disable-filter=colorkey --disable-filter=colorlevels --disable-filter=colormatrix --disable-filter=colorspace --disable-filter=compand --disable-filter=compensationdelay --disable-filter=concat --disable-filter=convolution --disable-filter=copy --disable-filter=cover_rect --disable-filter=cropdetect --disable-filter=crystalizer --disable-filter=curves --disable-filter=datascope --disable-filter=dcshift --disable-filter=dctdnoiz --disable-filter=deband --disable-filter=decimate --disable-filter=deflate --disable-filter=dejudder --disable-filter=delogo --disable-filter=deshake --disable-filter=detelecine --disable-filter=dilation --disable-filter=displace --disable-filter=drawbox --disable-filter=drawgraph --disable-filter=drawgrid --disable-filter=dynaudnorm --disable-filter=earwax --disable-filter=ebur128 --disable-filter=edgedetect --disable-filter=elbg --disable-filter=eq --disable-filter=equalizer --disable-filter=erosion --disable-filter=extractplanes --disable-filter=extrastereo --disable-filter=fade --disable-filter=fftfilt --disable-filter=field --disable-filter=fieldhint --disable-filter=fieldhint --disable-filter=fieldmatch --disable-filter=fieldorder --disable-filter=find_rect --disable-filter=firequalizer --disable-filter=flanger --disable-filter=format --disable-filter=fps --disable-filter=framepack --disable-filter=framerate --disable-filter=framestep --disable-filter=treble --disable-filter=tremolo --disable-filter=unsharp --disable-filter=uspp --disable-filter=vaguedenoiser --disable-filter=vectorscope --disable-filter=fspp --disable-filter=gblur --disable-filter=geq --disable-filter=gradfun --disable-filter=haldclut --disable-filter=haldclutsrc --disable-filter=hdcd --disable-filter=highpass --disable-filter=histeq --disable-filter=histogram --disable-filter=hqdn3d --disable-filter=hqx --disable-filter=hstack --disable-filter=hue --disable-filter=hwdownload --disable-filter=hwmap --disable-filter=hwupload --disable-filter=hysteresis --disable-filter=idet --disable-filter=il --disable-filter=inflate --disable-filter=interlace --disable-filter=interleave --disable-filter=join --disable-filter=kerndeint --disable-filter=lenscorrection --disable-filter=life --disable-filter=loop --disable-filter=loudnorm --disable-filter=lowpass --disable-filter=lut --disable-filter=lut2 --disable-filter=lut3d --disable-filter=lutrgb --disable-filter=lutyuv --disable-filter=mandelbrot --disable-filter=maskedclamp --disable-filter=maskedmerge --disable-filter=mcdeint --disable-filter=mergeplanes --disable-filter=mestimate --disable-filter=metadata --disable-filter=midequalizer --disable-filter=minterpolate --disable-filter=mpdecimate --disable-filter=mptestsrc --disable-filter=negate --disable-filter=nlmeans --disable-filter=nnedi --disable-filter=noformat --disable-filter=noise --disable-filter=owdenoise --disable-filter=palettegen --disable-filter=paletteuse --disable-filter=pan --disable-filter=perms --disable-filter=perspective --disable-filter=phase --disable-filter=pixdesctest --disable-filter=vibrato --disable-filter=vignette --disable-filter=volume --disable-filter=volumedetect --disable-filter=vstack --disable-filter=w3fdif --disable-filter=pp7 --disable-filter=premultiply --disable-filter=prewitt --disable-filter=psnr --disable-filter=pullup --disable-filter=qp --disable-filter=random --disable-filter=readeia608 --disable-filter=readvitc --disable-filter=realtime --disable-filter=remap --disable-filter=removegrain --disable-filter=removelogo --disable-filter=repeatfields --disable-filter=replaygain --disable-filter=reverse --disable-filter=rgbtestsrc --disable-filter=rotate --disable-filter=sab --disable-filter=scale2ref --disable-filter=select --disable-filter=selectivecolor --disable-filter=sendcmd --disable-filter=separatefields --disable-filter=setdar --disable-filter=setfield --disable-filter=setpts --disable-filter=setsar --disable-filter=settb --disable-filter=showcqt --disable-filter=showfreqs --disable-filter=showinfo --disable-filter=showpalette --disable-filter=showspectrum --disable-filter=showspectrumpic --disable-filter=showvolume --disable-filter=showwaves --disable-filter=showwavespic --disable-filter=shuffleframes --disable-filter=shuffleplanes --disable-filter=sidechaincompress --disable-filter=sidechaingate --disable-filter=sidedata --disable-filter=signalstats --disable-filter=signature --disable-filter=silencedetect --disable-filter=silenceremove --disable-filter=sine --disable-filter=smartblur --disable-filter=smptebars --disable-filter=smptehdbars --disable-filter=sobel --disable-filter=spectrumsynth --disable-filter=split --disable-filter=spp --disable-filter=ssim --disable-filter=stereo3d --disable-filter=stereotools --disable-filter=stereowiden --disable-filter=streamselect --disable-filter=super2xsai --disable-filter=swaprect --disable-filter=swapuv --disable-filter=tblend --disable-filter=telecine --disable-filter=waveform --disable-filter=weave --disable-filter=xbr --disable-filter=yadif --disable-filter=yuvtestsrc --disable-filter=zoompan --disable-filter=asetnsamples --disable-filter=reverse --disable-filter=atrim --disable-filter=trim --enable-filter=null --enable-filter=anull --enable-filter=crop --enable-filter=scale --enable-filter=transpose --enable-filter=movie --enable-filter=overlay --enable-filter=pad --enable-filter=reverse --enable-filter=areverse --enable-filter=color --enable-filter=trim --enable-filter=atrim --enable-filter=hflip --enable-filter=vflip --disable-iconv --prefix=/Users/meitu/Documents/ffmpeg_compile/android-build/ffmpeg/armv7a --cross-prefix=arm-linux-androideabi- --disable-doc --enable-cross-compile --target-os=linux --enable-pic --enable-asm --disable-xlib --disable-debug --enable-small --enable-inline-asm --enable-gpl --enable-nonfree --enable-libx264 --enable-encoder=libx264 --enable-libfdk-aac --enable-encoder=libfdk_aac --enable-libmp3lame --enable-encoder=libmp3lame --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -I/Users/meitu/Documents/ffmpeg_compile/android-build/x264/armv7a/include -I/Users/meitu/Documents/ffmpeg_compile/android-build/fdk-aac/armv7a/include -I/Users/meitu/Documents/ffmpeg_compile/android-build/lame/armv7a/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/Users/meitu/Documents/ffmpeg_compile/android-build/x264/armv7a/lib -lx264 -L/Users/meitu/Documents/ffmpeg_compile/android-build/fdk-aac/armv7a/lib -lfdk-aac -L/Users/meitu/Documents/ffmpeg_compile/android-build/lame/armv7a/lib -lmp3lame -Wl,--fix-cortex-a8' --extra-libs=-ldl"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/meitu/Documents/ffmpeg_compile/android-build/ffmpeg/armv7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/meitu/Documents/ffmpeg_compile/android-build/ffmpeg/armv7a/share/ffmpeg"
